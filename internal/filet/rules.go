...
var registry = []Rule{
	...
	{"ts.nesting", "block nesting exceeds limits.nesting (tree-sitter parse)"},
	{"ts.func.long", "function body exceeds limits.funcLines (tree-sitter parse)"},
	{"ts.func.statements", "function exceeds limits.funcStatements (tree-sitter parse)"},
	{"ts.func.params", "function exceeds limits.params (tree-sitter parse)"},
	{"ts.func.complexity", "cognitive complexity exceeds limits.complexity (tree-sitter parse)"},
	{"lsp.error", "language-server error diagnostic on the file"},
	{"lsp.warn", "language-server warning diagnostic on the file"},
	{"lsp.info", "language-server info or hint diagnostic on the file"},
	{"lsp.unavailable", "no usable language server for this file, so it was skipped"},
	...
	{"arch.dir.files", "directory holds more source files than architecture.maxFilesPerDir allows (off by default)"},
